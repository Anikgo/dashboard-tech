...
import { ArrowRight, Camera, Calendar, BarChart2 } from "lucide-react";

export default function InsightsPage() {
  return (
    <div className="p-6 max-w-6xl mx-auto fade-in">
      <h1 className="text-2xl font-semibold mb-1 text-guardai-darkgray">Insights</h1>
        ...
        <Card>
          ...
          <CardContent>
            <div className="flex items-end justify-between">
              ...
              <div className="text-guardai-red text-sm">+12% from yesterday</div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className="flex items-end justify-between">
              ...
              <div className="text-guardai-red text-sm">Requires attention</div>
            </div>
          </CardContent>
        </Card>
            ...
            <ul className="space-y-2">
              <li className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <Camera size={16} className="text-guardai-gray" />
