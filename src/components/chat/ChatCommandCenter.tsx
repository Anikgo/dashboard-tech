  ...
  const EmptyState = () => (
    ...
    >
      <motion.div variants={itemVariants} className="flex items-center gap-2 mb-6">
        <Shield size={32} className="text-guardai-red" />
      ...
      <div className="max-w-md">
        ...
        <motion.ul variants={itemVariants} className="space-y-3 text-guardai-gray">
          <li className="p-2 bg-guardai-lightgray/50 rounded-md hover:bg-guardai-lightgray transition-colors cursor-pointer">'Show me what happened near the loading dock yesterday'</li>
